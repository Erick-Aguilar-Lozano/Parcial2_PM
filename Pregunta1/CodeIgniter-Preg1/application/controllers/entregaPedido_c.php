 ...
 */
class EntregaPedido_c extends CI_Controller {

	public function __construct()
	{
			parent::__construct();
			$this->load->helper('url');
			$this->load->model('entregaPedido_model');
	}
	public function index()
	{
		$data['proceso'] = $this->entregaPedido_model->obt_codigo_proceso();
		$this->load->view('entregaPedido', $data);
